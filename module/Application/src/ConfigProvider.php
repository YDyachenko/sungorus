    ...
    public function getDependencyConfig()
    {
        return [
            ...
            'factories'          => [
                ...
                Authentication\AuthSuccessListener::class        => Authentication\Factory\AuthSuccessListenerFactory::class,
                Authentication\AuthFailureListener::class        => Authentication\Factory\AuthFailureListenerFactory::class,
